...
<html>
<head>
    <title>MLU Admission Form</title>
...
<body>
    ...
    <table width="100%" style="margin-top:-45px;">
        <tr>
            ...
            <td rowspan="4"><img src="{{asset(Auth::user()->studentDocuments->where('document_category_id',1)->first()->document)}}" style="width: 100%; max-width: 120px"></td>
            <td rowspan="4"><img src="{{asset(Auth::user()->studentDocuments->where('document_category_id',2)->first()->document)}}" style="max-height: 50px"></td>
        </tr>
        <tr>
