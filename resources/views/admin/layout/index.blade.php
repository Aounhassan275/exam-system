			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu {{Request::is('admin/college*') || Request::is('admin/student') || Request::is('admin/student/*') || Request::is('admin/teacher*') || Request::is('admin/prospect*') ?'nav-item-open':''}}">
							<a href="#" class="nav-link"><i class="icon-cart-remove"></i> <span>Users</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('admin/college*') || Request::is('admin/student') || Request::is('admin/student/*') || Request::is('admin/teacher*') || Request::is('admin/prospect*')?'display:block':''}}">
								...
								<li class="nav-item"><a href="{{route('admin.prospect.index')}}" class="nav-link {{Request::is('admin/prospect')?'active':''}}">Prospect</a></li>
							</ul>
						</li>
